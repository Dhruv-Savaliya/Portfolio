...
export default function SmartReceipt() {
  ...
  useEffect(() => {
    ...
    const morphTrigger = ScrollTrigger.create({
      ...
      start: 'top 55%',
      onEnter: () => setCoreMorphTarget('smartreceipt'),
      onLeaveBack: () => setCoreMorphTarget('clearclaim'),
    });
  ...
  return (
    <section
      ...
      aria-label="SmartReceipt — OCR Data Extraction"
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-start">
        ...
        <div ref={leftColRef} className="flex flex-col gap-6 max-w-xl">
          ...
          <p className="font-body text-white/60 text-sm leading-relaxed max-w-md">
            Extract text from receipts using OCR and convert them into structured data with AI processing.
          </p>

          <div className="flex flex-wrap gap-2 mt-2">
            {['Next.js', 'Tesseract.js', 'Node.js', 'Tailwind'].map((tech) => (
